  ...
  return (
    <div className="flex min-h-[100dvh] items-center justify-center bg-background px-4">
      <div className="text-left max-w-xs fade-in-up">
        <p className="font-display text-7xl font-bold text-primary/20 mb-4 leading-none">404</p>
        <h1 className="font-display text-xl font-bold mb-2 tracking-tight">Página não encontrada</h1>
        <p className="text-sm text-muted-foreground mb-6">
          A rota <code className="text-xs bg-muted px-1.5 py-0.5 rounded">{location.pathname}</code> não existe.
        </p>
        <a href="/">
